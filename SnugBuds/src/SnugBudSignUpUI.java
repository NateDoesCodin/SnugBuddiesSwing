...
public class SnugBudSignUpUI extends JFrame {
    public SnugBudSignUpUI() {
        JFrame signupframe = new JFrame("SnugBud - Sign Up");
        signupframe.setLayout(null); // Allows absolute positioning

        // Manually set fullscreen-like size without exclusive fullscreen mode
        signupframe.setSize(1720, 800);
        signupframe.setLocationRelativeTo(null); // Center the frame on screen
      ...
      signupframe.getContentPane().setSize(1720,800);
